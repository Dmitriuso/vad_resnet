...
parser.add_argument('--training-speech-dir', type=str, default='./dataset/raw_data/test-clean', help='path where to find training speech data')
parser.add_argument('--test-speech-dir', type=str, default='./dataset/test_data', help='path where to find test speech data')
parser.add_argument('--label-dir', type=str, default='./dataset/labels', help='path where to find segmented label of raw data')
